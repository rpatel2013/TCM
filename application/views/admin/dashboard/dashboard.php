  ...
  <body class="  ">
          ...
          <div class="container-fluid">
            ...
            <div class="topnav">
              ...
              <div class="btn-group">
                ...
                <a href="<?php echo base_url('index.php/admin/user/logout'); ?>" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm">
          ...
          <div class="inner bg-light lter">
            <div class="col-lg-12">
              ...
              <ul>
                ...
                <li>
                  <p>Bootstrap 3.3.0
                    <a href="https://github.com/onokumus/Bootstrap-Admin-Template/archive/master.zip">v2.3.1</a> 
                    ready <code>dist</code> folder your use</p>
                </li>
              </ul>
              <h3 id="building">Building</h3>
              <h4 id="2-3-1-version">2.3.1 Version</h4>
              <p>required
    ...
    $ npm install
    $ npm run build
    $ grunt connect</code></pre>
              <h4 id="2-3-1-rtl-version">2.3.1 RTL Version</h4>
              <p>required
                <a href="http://nodejs.org/">node.js</a> &amp;
                <a href="http://bower.io/">bower</a> &amp;
                <a href="http://gruntjs.com/getting-started">grunt</a> 
...
$ open index.html</code></pre>
              <h3 id="demo">Demo</h3>
              <ul>
                <li> <a href="http://demo.onokumus.com/metis/">Demo v2.3.1</a>  </li>
                <li> <a href="http://demo.onokumus.com/metis/rtl/">RTL v2.3.1</a>  </li>
                <li>
              ...
              <ul>
                <li>2014-11-01 v2.3.1 Bootstrap 3.3.0, fixed jquery-timepicker stylesheet, added metisMenu<pre><code>                       plugin, many plugin updated                                         </code></pre>
                </li>
                <li>2014-07-18 v2.2.7 added some layouts sample</li>
              ...
              <p><em>This file was generated by <a href="https://github.com/assemble/verb-cli">verb-cli</a>  on November 01, 2014.</em> 
              </p>
            </div>
          </div><!-- /.inner -->
        </div><!-- /.outer -->
